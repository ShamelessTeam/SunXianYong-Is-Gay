# Generated by Django 2.0.5 on 2018-06-01 12:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.Account', verbose_name='会员名')),
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='luffy_main.Comment', verbose_name='父级评论')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='luffy_main.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.Course')),
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='luffy_main.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.CourseDetail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='luffy_main.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.CourseCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.DegreeCourse')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.Account')),
            ],
        ),
        migrations.AddField(
            model_name='degreecourse',
            name='teachers',
            field=models.ManyToManyField(to='luffy_main.Teacher', verbose_name='课程讲师'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='若是学位课程，此处关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='luffy_main.DegreeCourse'),
        ),
        migrations.AddField(
            model_name='course',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.CourseSubCategory'),
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='luffy_main.ArticleSource', verbose_name='来源'),
        ),
