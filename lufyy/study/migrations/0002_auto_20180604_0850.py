# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-06-04 08:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.Account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.Account', verbose_name='会员名')),
                ...
                ('p_node', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='study.Comment', verbose_name='父级评论')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='study.Account')),
            ],
        ),
        migrations.AlterModelOptions(
            name='course',
            options={'verbose_name_plural': '06.学位(专题)课程'},
        ),
        migrations.AddField(
            model_name='article',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.ArticleSource', verbose_name='来源'),
        ),
