# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-05-31 10:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursechapters', to='study.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recommend_courses', models.ManyToManyField(blank=True, related_name='recommend_by', to='study.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.CourseDetail')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursesections', to='study.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.CourseCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chapter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.CourseChapter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degree_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.DegreeCourse')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='teachers',
            field=models.ManyToManyField(to='study.Teacher', verbose_name='课程讲师'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='course',
            name='degree_course',
            field=models.ForeignKey(blank=True, help_text='若是学位课程，此处关联学位表', null=True, on_delete=django.db.models.deletion.CASCADE, to='study.DegreeCourse'),
        ),
        migrations.AddField(
            model_name='course',
            name='sub_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='study.CourseSubCategory'),
        ),
